...
#define GROUPID_MA				1				//马
#define GROUPID_SHE				2				//蛇
#define GROUPID_LONG			3				//龙
#define GROUPID_TU				4				//兔
#define GROUPID_HU				5				//虎
#define GROUPID_NIU				6				//牛
#define GROUPID_SHU				7				//鼠
#define GROUPID_ZHU				8				//猪
#define GROUPID_GOU				9				//狗
#define GROUPID_JI				10				//鸡
#define GROUPID_HOU				11				//猴
#define GROUPID_YANG			12				//羊
