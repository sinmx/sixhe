...
public:
    ...
    void Selected(bool bSelected, bool bNeedNotifyEvent=true);
...
public:
	...
	//示例相关属性
	void SetExampleText(LPCTSTR szText) {m_sExampleText = szText;}
	LPCTSTR GetExampleText() {return m_sExampleText.GetData();}
	void SetExampleTextColor(DWORD dwColor) {m_dwExampleTextColor = dwColor;}
	DWORD GetExampleTextColor() {return m_dwExampleTextColor;}
	void SetExampleBkColor(DWORD dwColor) {m_dwExampleBkColor = dwColor;}
	DWORD GetExampleBkColor() {return m_dwExampleBkColor;}
...
protected:
	...
	CStdString m_sExampleText;		//示例文本
	DWORD m_dwExampleTextColor;		//示例文本颜色
	DWORD m_dwExampleBkColor;		//示例背景颜色
};
