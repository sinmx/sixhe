    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
        ...
        if( _tcscmp(pstrClass, _T("Include")) == 0 ) {
            ...
            case 4:
				...
				else if( _tcscmp(pstrClass, _T("Icon")) == 0 )              pControl = new CIconUI;
				else if( _tcscmp(pstrClass, _T("Tree")) == 0 )              pControl = new CTreeUI;
                break;
            case 5:
            ...
            case 9:
				...
				else if( _tcscmp(pstrClass, _T("PlayImage")) == 0 )			pControl = new CPlayImageUI;	//extend
                break;
            case 10:
			...
			case 11:
				...
				break;
			case 12:
				if (_tcscmp(pstrClass, _T("WndContainer")) == 0)
				{
					pControl = new CUIWndContainer(pManager->GetWndContainerCallback());
				}
				break;
            case 14:
